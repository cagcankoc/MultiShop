...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class CargoController : Controller
    {
		...
		void CommonCargoCompanyViewBagList(string currentPage)
		{
			ViewBag.v0 = "Kargo Firma İşlemleri";
			ViewBag.v1 = "Ana Sayfa";
			ViewBag.v2 = "Kargo Firmaları";
        ...
        {
			CommonCargoCompanyViewBagList("Kargo Firma Listesi");
        ...
        {
			CommonCargoCompanyViewBagList("Yeni Kargo Firma Girişi");
			return View();
        }
        ...
        {
			CommonCargoCompanyViewBagList("Kargo Firma Güncelleme");
